...
public class RandomSimpleGraph : MonoBehaviour
{
    public int numNodes;
    ...
    public List<(string, string)> connectionList = new List<(string, string)>();
    [System.NonSerialized]
    ...
    void CreateGraph()
    {
        ...
        for (int i = 0; i < numNodes; i++)
        {
            ...
            List<string> neighboursOfNodeA = new List<string>();
            ...
            for (int j = 0; j < numNodes; j++)
            {
                ...
                {
                    connectionList.Add((nodeA, nodeB));
                    neighboursOfNodeA.Add(nodeB);
                }
            }
